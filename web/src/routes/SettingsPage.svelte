...
<div class="settings-page">
    ...
    <div class="settings-row">
      ...
      <div class="settings-control">
        <select data-setting="pi-sessions:spinner-style">
          <option value="runcat">Runcat</option>
  ...
  <section class="settings-section">
    ...
    <div class="settings-row">
      ...
      <div class="settings-control">
        <label class="settings-toggle">
          <input type="checkbox" data-setting="pi-web:v1:auto-title:enabled" data-setting-bool>
          <span class="slider"></span>
        </label>
      </div>
    </div>
  ...
  <section class="settings-section">
    ...
    <div class="settings-row">
      ...
      <div class="settings-control">
        <label class="settings-toggle">
          <input type="checkbox" data-setting="pi-share:v1:notify-on-done" data-setting-bool data-setting-notify>
          <span class="slider"></span>
        </label>
      </div>
    </div>
  ...
  <section class="settings-section">
    ...
    <div class="settings-row">
      ...
      <div class="settings-control">
        <label class="settings-toggle">
          <input type="checkbox" data-setting="pi-web:v1:cat:enabled" data-setting-bool>
          <span class="slider"></span>
        </label>
      </div>
    </div>
